...
public class EducatorImpl implements Educator {
     ...
     * @param x
     */
    public EducatorImpl(int x, int y, String direction, char[][] mazeData) {
        // Initialize the maze state with the initial maze and robot position
        MazeState mazeState = new MazeState(mazeData, x, y); // Assuming the robot starts at position (2, 2)
        this.currentMazeState = mazeState;

        // Initialize the robot with the initial maze
        this.robot = new Robot(mazeData,x,y,direction);
